...
module ActionController
  ...
  module ImplicitRender
    ...
    def default_render
      if template_exists?(action_name, _prefixes, variants: request.variant)
        render
      elsif any_templates?(action_name, _prefixes)
        message = "#{self.class.name} is missing a template " \
